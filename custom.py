...
import skimage.draw
#import cv2
#from model.visualize import display_instances
#import matplotlib.pyplot as plt

# Root directory of the project
ROOT_DIR = r'D:/Tech Projects/vehicle_damage_detection/Mask_RCNN_damage_detector/'

# Import Mask RCNN
sys.path.append(ROOT_DIR)  # To find local version of the library
from model.config import Config
from model import model as modellib, utils
...
if __name__ == '__main__':
    ...
    if args.weights.lower() == "coco":
        ...
        model.load_weights(weights_path, by_name=True, exclude=[
            "model_class_logits", "model_bbox_fc",
            "model_bbox", "model_mask"])
    else:
